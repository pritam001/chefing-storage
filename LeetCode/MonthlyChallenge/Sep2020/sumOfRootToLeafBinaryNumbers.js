...
const sumRootToLeaf = function (root) {
    const sumArray = sumRootToLeafStep(root, 0);
...
const sumRootToLeafStep = function (root, upValue) {
    ...
    const currentValue = upValue * 2 + root.val;
    const currentArray = (root.left == null && root.right == null) ? [currentValue] : [];
    const leftArray = root.left != null ? sumRootToLeafStep(root.left, currentValue) : [];
    const rightArray = root.right != null ? sumRootToLeafStep(root.right, currentValue) : [];
